...
if ( ! class_exists( 'PostStatusBroadcaster_ToggleCustomFieldType' ) ) :
/**
 ...
 */
class PostStatusBroadcaster_ToggleCustomFieldType extends PostStatusBroadcaster_AdminPageFramework_FieldType_checkbox {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery( '.switch_toggle_buttons' ).each( function () {
                ...
                jQuery( this ).closest( '.post-status-broadcaster-field' )
                    .children( '.post-status-broadcaster-checkbox-container-toggle' )
                    .hide();

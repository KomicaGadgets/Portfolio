 ...
 * @package     PostStatusBroadcaster_AdminPageFramework
 */

if ( ! class_exists( 'PostStatusBroadcaster_Select2CustomFieldType' ) ) :
/**
 ...
 */
class PostStatusBroadcaster_Select2CustomFieldType extends PostStatusBroadcaster_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.post-status-broadcaster-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.post-status-broadcaster-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.post-status-broadcaster-select-label' )
                .children( 'label' )
                .children( '.post-status-broadcaster-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set initial values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.post-status-broadcaster-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.post-status-broadcaster-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    jQuery().registerPostStatusBroadcaster_AdminPageFrameworkCallbacks( {
        /**
    ...
    protected function getStyles() {
        return "
.post-status-broadcaster-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.post-status-broadcaster-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .post-status-broadcaster-field-select2 > .post-status-broadcaster-select-label > label > .post-status-broadcaster-input-container {
    max-width: 84%;
}

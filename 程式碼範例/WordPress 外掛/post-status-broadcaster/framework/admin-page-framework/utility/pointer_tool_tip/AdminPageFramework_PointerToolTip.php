...
class PostStatusBroadcaster_AdminPageFramework_PointerToolTip extends PostStatusBroadcaster_AdminPageFramework_FrameworkUtility {
    ...
    public function _replyToInsertInternalScript() {
        echo "<script type='text/javascript' class='post-status-broadcaster-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->_getInternalScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }

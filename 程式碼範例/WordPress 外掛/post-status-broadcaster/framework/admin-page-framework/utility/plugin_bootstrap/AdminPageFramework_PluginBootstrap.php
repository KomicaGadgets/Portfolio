...
abstract class PostStatusBroadcaster_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('PostStatusBroadcaster_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new PostStatusBroadcaster_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }

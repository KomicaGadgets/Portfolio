...
class PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission__Validator_Base extends PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    ...
    class PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission__Validator extends PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission__Validator_Base {
        public $oFactory;
        ...
        public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
            ...
            $_aClassNames = array('PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission__Validator__Link', 'PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission__Validator__Import', 'PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission__Validator__Export', 'PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
            ...
            try {
                ...
                $_oFormSubmissionFilter = new PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);

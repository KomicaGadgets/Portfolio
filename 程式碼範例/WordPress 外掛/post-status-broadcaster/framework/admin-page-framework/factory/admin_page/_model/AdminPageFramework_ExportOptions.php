...
abstract class PostStatusBroadcaster_AdminPageFramework_CustomSubmitFields extends PostStatusBroadcaster_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
    ...
    class PostStatusBroadcaster_AdminPageFramework_ExportOptions extends PostStatusBroadcaster_AdminPageFramework_CustomSubmitFields {
        public $sClassName;
        public $sFileName;
        public $sFormatType;
        public $bIsDataSet;
            ...
            switch (strtolower($sFormatType)) {
                case 'text':
                    if (in_array(gettype($vData), array('array', 'object'))) {
                        echo PostStatusBroadcaster_AdminPageFramework_Debug::get($vData, null, false);
                    }
                    echo $vData;
                    return;
                case 'json':

...
abstract class PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission_Base extends PostStatusBroadcaster_AdminPageFramework_Form_Utility {
    ...
    class PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission extends PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission_Base {
        public $oFactory;
        public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            $this->oFactory = $oFactory;
            $this->_handleFormData();
            new PostStatusBroadcaster_AdminPageFramework_Model__FormRedirectHandler($oFactory);
        }
        public function _handleFormData() {
            ...
            new PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);

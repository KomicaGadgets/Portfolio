...
class PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission__Validator__Filter extends PostStatusBroadcaster_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;

...
class PostStatusBroadcaster_AdminPageFramework_Property_admin_page extends PostStatusBroadcaster_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'post-status-broadcaster') {
        ...
        $GLOBALS['aPostStatusBroadcaster_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aPostStatusBroadcaster_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aPostStatusBroadcaster_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;

...
abstract class PostStatusBroadcaster_AdminPageFramework_PageMetaBox_Router extends PostStatusBroadcaster_AdminPageFramework_MetaBox_View {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_PageMetaBox_Model extends PostStatusBroadcaster_AdminPageFramework_PageMetaBox_Router {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_PageMetaBox_View extends PostStatusBroadcaster_AdminPageFramework_PageMetaBox_Model {
    }
    abstract class PostStatusBroadcaster_AdminPageFramework_PageMetaBox_Controller extends PostStatusBroadcaster_AdminPageFramework_PageMetaBox_View {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_PageMetaBox extends PostStatusBroadcaster_AdminPageFramework_PageMetaBox_Controller {
        protected $_sStructureType = 'page_meta_box';
        public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'post-status-broadcaster') {

...
class PostStatusBroadcaster_AdminPageFramework_Property_page_meta_box extends PostStatusBroadcaster_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'post-status-broadcaster', $sStructureType = 'page_meta_box') {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS['aPostStatusBroadcaster_AdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('aPostStatusBroadcaster_AdminPageFramework', 'aMetaBoxForPagesClasses'));
        $GLOBALS['aPostStatusBroadcaster_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('aPostStatusBroadcaster_AdminPageFramework', 'aPageClasses'));

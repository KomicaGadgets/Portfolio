...
abstract class PostStatusBroadcaster_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        PostStatusBroadcaster_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return PostStatusBroadcaster_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        PostStatusBroadcaster_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return PostStatusBroadcaster_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        PostStatusBroadcaster_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        PostStatusBroadcaster_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        PostStatusBroadcaster_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'PostStatusBroadcaster_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_Utility_VariableType extends PostStatusBroadcaster_AdminPageFramework_Utility_Deprecated {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_Utility_String extends PostStatusBroadcaster_AdminPageFramework_Utility_VariableType {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_Utility_Array extends PostStatusBroadcaster_AdminPageFramework_Utility_String {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_Utility_ArrayGetter extends PostStatusBroadcaster_AdminPageFramework_Utility_Array {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_Utility_ArraySetter extends PostStatusBroadcaster_AdminPageFramework_Utility_ArrayGetter {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_Utility_Path extends PostStatusBroadcaster_AdminPageFramework_Utility_ArraySetter {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_Utility_URL extends PostStatusBroadcaster_AdminPageFramework_Utility_Path {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_Utility_File extends PostStatusBroadcaster_AdminPageFramework_Utility_URL {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_Utility_SystemInformation extends PostStatusBroadcaster_AdminPageFramework_Utility_File {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_Utility_HTMLAttribute extends PostStatusBroadcaster_AdminPageFramework_Utility_SystemInformation {
    ...
    class PostStatusBroadcaster_AdminPageFramework_Utility extends PostStatusBroadcaster_AdminPageFramework_Utility_HTMLAttribute {

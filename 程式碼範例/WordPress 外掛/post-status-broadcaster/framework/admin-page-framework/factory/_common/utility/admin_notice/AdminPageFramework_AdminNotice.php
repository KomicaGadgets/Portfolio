...
class PostStatusBroadcaster_AdminPageFramework_AdminNotice extends PostStatusBroadcaster_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'post-status-broadcaster-settings-notice-message', 'post-status-broadcaster-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new PostStatusBroadcaster_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }

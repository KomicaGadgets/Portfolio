...
class PostStatusBroadcaster_AdminPageFramework_Debug_Base extends PostStatusBroadcaster_AdminPageFramework_FrameworkUtility {
    ...
    class PostStatusBroadcaster_AdminPageFramework_Debug_Log extends PostStatusBroadcaster_AdminPageFramework_Debug_Base {
    ...
    class PostStatusBroadcaster_AdminPageFramework_Debug extends PostStatusBroadcaster_AdminPageFramework_Debug_Log {
        ...
        static public function dumpArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('PostStatusBroadcaster_AdminPageFramework_Debug::' . __FUNCTION__, 'PostStatusBroadcaster_AdminPageFramework_Debug::dump()');
            PostStatusBroadcaster_AdminPageFramework_Debug::dump($asArray, $sFilePath);
        }
        static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
            self::showDeprecationNotice('PostStatusBroadcaster_AdminPageFramework_Debug::' . __FUNCTION__, 'PostStatusBroadcaster_AdminPageFramework_Debug::get()');
            return PostStatusBroadcaster_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
        }
        static public function logArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('PostStatusBroadcaster_AdminPageFramework_Debug::' . __FUNCTION__, 'PostStatusBroadcaster_AdminPageFramework_Debug::log()');
            PostStatusBroadcaster_AdminPageFramework_Debug::log($asArray, $sFilePath);
        }
        static public function getAsString($mValue) {
            self::showDeprecationNotice('PostStatusBroadcaster_AdminPageFramework_Debug::' . __FUNCTION__);

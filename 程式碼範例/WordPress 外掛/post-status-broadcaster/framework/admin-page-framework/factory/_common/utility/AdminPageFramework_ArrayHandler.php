...
class PostStatusBroadcaster_AdminPageFramework_FrameworkUtility extends PostStatusBroadcaster_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = PostStatusBroadcaster_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return PostStatusBroadcaster_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
    }
    class PostStatusBroadcaster_AdminPageFramework_ArrayHandler extends PostStatusBroadcaster_AdminPageFramework_FrameworkUtility {
        public $aData = array();

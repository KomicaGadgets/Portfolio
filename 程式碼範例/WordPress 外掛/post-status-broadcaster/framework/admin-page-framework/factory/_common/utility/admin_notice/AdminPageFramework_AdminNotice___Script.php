...
class PostStatusBroadcaster_AdminPageFramework_AdminNotice___Script extends PostStatusBroadcaster_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.post-status-broadcaster-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='post-status-broadcaster-admin-notice-animation-container'></div>" );

...
class PostStatusBroadcaster_AdminPageFramework_Form_View___Script_Widget extends PostStatusBroadcaster_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.post-status-broadcaster-sectionset' ).length <= 0 ) { 
                    return; 
                }   
                ...
                $( document ).trigger( 
                    'post-status-broadcaster_saved_widget', 
                    _oWidget 
                );

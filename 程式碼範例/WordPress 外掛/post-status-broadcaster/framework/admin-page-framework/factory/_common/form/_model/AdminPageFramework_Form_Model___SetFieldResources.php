...
class PostStatusBroadcaster_AdminPageFramework_Form_Model___SetFieldResources extends PostStatusBroadcaster_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new PostStatusBroadcaster_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('PostStatusBroadcaster_AdminPageFramework_Form_View___CSS_Form', 'PostStatusBroadcaster_AdminPageFramework_Form_View___CSS_Field', 'PostStatusBroadcaster_AdminPageFramework_Form_View___CSS_Section', 'PostStatusBroadcaster_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'PostStatusBroadcaster_AdminPageFramework_Form_View___CSS_FieldError', 'PostStatusBroadcaster_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('PostStatusBroadcaster_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new PostStatusBroadcaster_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new PostStatusBroadcaster_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);

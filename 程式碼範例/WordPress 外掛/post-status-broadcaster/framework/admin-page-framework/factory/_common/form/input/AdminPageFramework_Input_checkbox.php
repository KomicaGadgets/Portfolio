...
abstract class PostStatusBroadcaster_AdminPageFramework_Input_Base extends PostStatusBroadcaster_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'post-status-broadcaster-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'post-status-broadcaster-input-label-string',),);
    ...
    class PostStatusBroadcaster_AdminPageFramework_Input_checkbox extends PostStatusBroadcaster_AdminPageFramework_Input_Base {

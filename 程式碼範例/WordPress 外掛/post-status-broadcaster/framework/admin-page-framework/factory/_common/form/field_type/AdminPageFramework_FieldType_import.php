...
class PostStatusBroadcaster_AdminPageFramework_FieldType_import extends PostStatusBroadcaster_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".post-status-broadcaster-field-import input {margin-right: 0.5em;}.post-status-broadcaster-field-import label,.form-table td fieldset.post-status-broadcaster-fieldset .post-status-broadcaster-field-import label { display: inline; }";
    }

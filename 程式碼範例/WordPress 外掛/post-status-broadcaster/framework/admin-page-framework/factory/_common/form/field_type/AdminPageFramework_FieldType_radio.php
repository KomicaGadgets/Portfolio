...
class PostStatusBroadcaster_AdminPageFramework_FieldType_radio extends PostStatusBroadcaster_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".post-status-broadcaster-field input[type='radio'] {margin-right: 0.5em;} .post-status-broadcaster-field-radio .post-status-broadcaster-input-label-container {padding-right: 1em;} .post-status-broadcaster-field-radio .post-status-broadcaster-input-container {display: inline;} .post-status-broadcaster-field-radio .post-status-broadcaster-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.post-status-broadcaster-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).prop( 'checked', false );

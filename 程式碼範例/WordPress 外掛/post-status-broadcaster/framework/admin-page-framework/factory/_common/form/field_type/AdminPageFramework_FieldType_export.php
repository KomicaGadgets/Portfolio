...
class PostStatusBroadcaster_AdminPageFramework_FieldType_submit extends PostStatusBroadcaster_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".post-status-broadcaster-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'post-status-broadcaster-input-label-container' . ' post-status-broadcaster-input-button-container' . ' post-status-broadcaster-input-container',);
    }
    ...
    class PostStatusBroadcaster_AdminPageFramework_FieldType_export extends PostStatusBroadcaster_AdminPageFramework_FieldType_submit {

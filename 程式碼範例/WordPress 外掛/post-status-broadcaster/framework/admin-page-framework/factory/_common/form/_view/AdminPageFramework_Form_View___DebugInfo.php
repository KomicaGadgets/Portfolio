...
class PostStatusBroadcaster_AdminPageFramework_Form_View___DebugInfo extends PostStatusBroadcaster_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='post-status-broadcaster-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }

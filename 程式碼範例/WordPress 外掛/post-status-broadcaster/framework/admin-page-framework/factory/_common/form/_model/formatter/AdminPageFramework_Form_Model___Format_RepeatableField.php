...
class PostStatusBroadcaster_AdminPageFramework_Form_Model___Format_RepeatableSection extends PostStatusBroadcaster_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : PostStatusBroadcaster_AdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class PostStatusBroadcaster_AdminPageFramework_Form_Model___Format_RepeatableField extends PostStatusBroadcaster_AdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {

...
class PostStatusBroadcaster_AdminPageFramework_Form_View___Script_SectionTab extends PostStatusBroadcaster_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.post-status-broadcaster-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='post-status-broadcaster-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }

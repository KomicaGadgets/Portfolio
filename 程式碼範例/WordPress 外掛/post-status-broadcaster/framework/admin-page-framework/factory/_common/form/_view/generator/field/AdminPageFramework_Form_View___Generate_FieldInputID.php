...
class PostStatusBroadcaster_AdminPageFramework_Form_View___Generate_FieldTagID extends PostStatusBroadcaster_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
    ...
    class PostStatusBroadcaster_AdminPageFramework_Form_View___Generate_FieldInputID extends PostStatusBroadcaster_AdminPageFramework_Form_View___Generate_FieldTagID {
        public $isIndex = '';

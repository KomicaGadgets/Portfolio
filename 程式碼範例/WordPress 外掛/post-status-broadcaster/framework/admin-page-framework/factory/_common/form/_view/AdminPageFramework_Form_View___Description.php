...
class PostStatusBroadcaster_AdminPageFramework_Form_View___Description extends PostStatusBroadcaster_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'post-status-broadcaster-form-element-description';

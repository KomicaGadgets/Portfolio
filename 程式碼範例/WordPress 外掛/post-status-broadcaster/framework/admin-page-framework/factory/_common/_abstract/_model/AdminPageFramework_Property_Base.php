...
abstract class PostStatusBroadcaster_AdminPageFramework_Property_Base extends PostStatusBroadcaster_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'post-status-broadcaster' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aPostStatusBroadcaster_AdminPageFramework'])) {
            $GLOBALS['aPostStatusBroadcaster_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => PostStatusBroadcaster_AdminPageFramework_Registry::NAME, 'sURI' => PostStatusBroadcaster_AdminPageFramework_Registry::URI, 'sScriptName' => PostStatusBroadcaster_AdminPageFramework_Registry::NAME, 'sLibraryName' => PostStatusBroadcaster_AdminPageFramework_Registry::NAME, 'sLibraryURI' => PostStatusBroadcaster_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => PostStatusBroadcaster_AdminPageFramework_Registry::getVersion(), 'sDescription' => PostStatusBroadcaster_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => PostStatusBroadcaster_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => PostStatusBroadcaster_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => PostStatusBroadcaster_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => PostStatusBroadcaster_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new PostStatusBroadcaster_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
    }

...
abstract class PostStatusBroadcaster_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'PostStatusBroadcaster_AdminPageFramework_Form_', 'oPageLoadInfo' => 'PostStatusBroadcaster_AdminPageFramework_PageLoadInfo_', 'oResource' => 'PostStatusBroadcaster_AdminPageFramework_Resource_', 'oHelpPane' => 'PostStatusBroadcaster_AdminPageFramework_HelpPane_', 'oLink' => 'PostStatusBroadcaster_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'PostStatusBroadcaster_AdminPageFramework_Debug', 'oUtil' => 'PostStatusBroadcaster_AdminPageFramework_FrameworkUtility', 'oMsg' => 'PostStatusBroadcaster_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(PostStatusBroadcaster_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return PostStatusBroadcaster_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_Factory_Model extends PostStatusBroadcaster_AdminPageFramework_Factory_Router {
        public function __construct($oProp) {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_Factory_View extends PostStatusBroadcaster_AdminPageFramework_Factory_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            new PostStatusBroadcaster_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
        }
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_Factory_Controller extends PostStatusBroadcaster_AdminPageFramework_Factory_View {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_Factory extends PostStatusBroadcaster_AdminPageFramework_Factory_Controller {
    }

...
abstract class PostStatusBroadcaster_AdminPageFramework_PostType_Router extends PostStatusBroadcaster_AdminPageFramework_Factory {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_PostType_Model extends PostStatusBroadcaster_AdminPageFramework_PostType_Router {
        public function __construct($oProp) {
            parent::__construct($oProp);
            ...
            if ($this->oProp->bIsAdmin) {
                ...
                if ($this->oProp->sCallerPath) {
                    new PostStatusBroadcaster_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
                }
            }
        }
        ...
        public function _replyToRegisterPostType() {
            ...
            new PostStatusBroadcaster_AdminPageFramework_PostType_Model__SubMenuOrder($this);
        }
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_PostType_View extends PostStatusBroadcaster_AdminPageFramework_PostType_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            if ($this->oProp->bIsAdmin) {
        ...
        public function _replyToPrintStyle() {
            ...
            if (!empty($this->oProp->sStyle)) {
                echo "<style type='text/css' id='post-status-broadcaster-style-post-type'>" . $this->oProp->sStyle . "</style>";
            }
        }
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_PostType_Controller extends PostStatusBroadcaster_AdminPageFramework_PostType_View {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_PostType extends PostStatusBroadcaster_AdminPageFramework_PostType_Controller {
        protected $_sStructureType = 'post_type';
        public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'post-status-broadcaster') {
            if (empty($sPostType)) {
                return;
            }
            $_sProprtyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'PostStatusBroadcaster_AdminPageFramework_Property_' . $this->_sStructureType;
            ...
            $this->oProp->sPostType = PostStatusBroadcaster_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
            $this->oProp->aPostTypeArgs = $aArguments;
        ...
        private function _getCallerScriptPath($sCallerPath) {
            ...
            $_sPageNow = PostStatusBroadcaster_AdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
            if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
                return PostStatusBroadcaster_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
            }
            return null;
        }
    }

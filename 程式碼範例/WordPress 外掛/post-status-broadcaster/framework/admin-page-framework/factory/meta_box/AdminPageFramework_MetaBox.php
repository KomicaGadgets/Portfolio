...
abstract class PostStatusBroadcaster_AdminPageFramework_MetaBox_Router extends PostStatusBroadcaster_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'post-status-broadcaster') {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_MetaBox_Model extends PostStatusBroadcaster_AdminPageFramework_MetaBox_Router {
        public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'post-status-broadcaster') {
        ...
        public function _replyToGetSavedFormData() {
            $_oMetaData = new PostStatusBroadcaster_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_MetaBox_View extends PostStatusBroadcaster_AdminPageFramework_MetaBox_Model {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_MetaBox_Controller extends PostStatusBroadcaster_AdminPageFramework_MetaBox_View {
    ...
    abstract class PostStatusBroadcaster_AdminPageFramework_MetaBox extends PostStatusBroadcaster_AdminPageFramework_MetaBox_Controller {

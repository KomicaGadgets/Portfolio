...
class PostStatusBroadcaster_AdminPageFramework_Property_post_meta_box extends PostStatusBroadcaster_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'post-status-broadcaster', $sStructureType = 'post_meta_box') {
